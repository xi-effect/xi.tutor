/** Заголовок секции кабинета: Playfair, как виджеты на главной. */
export const sectionTitleClass =
  'font-playfair text-text-primary m-0 shrink-0 text-2xl leading-none font-medium first-letter:uppercase sm:text-3xl';
