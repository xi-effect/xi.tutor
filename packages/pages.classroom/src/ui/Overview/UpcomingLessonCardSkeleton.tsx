export const UpcomingLessonCardSkeleton = () => (
  <div className="bg-background-surface flex min-h-[220px] w-full max-w-[400px] min-w-[300px] animate-pulse flex-col gap-2 rounded-2xl p-5 shadow-[0px_2px_8px_0px_rgba(0,0,0,0.08)] sm:min-w-[320px]">
