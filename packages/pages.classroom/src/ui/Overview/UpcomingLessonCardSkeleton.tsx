export const UpcomingLessonCardSkeleton = () => (
  <div className="border-gray-10 bg-gray-0 flex min-h-[220px] w-full max-w-[400px] min-w-[300px] animate-pulse flex-col gap-2 rounded-2xl border p-5 sm:min-w-[320px]">
