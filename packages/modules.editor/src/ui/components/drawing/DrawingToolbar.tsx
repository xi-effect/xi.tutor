...
export const DrawingToolbar = ({
  ...
  return (
    <div
      data-editor-ignore
      className="bg-background-surface border-border-default absolute top-0 -right-10 z-10 flex flex-col items-center gap-1 rounded-lg border p-1 py-2 shadow-md"
    >
