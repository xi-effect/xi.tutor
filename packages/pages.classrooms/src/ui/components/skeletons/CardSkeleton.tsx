      ...
      <div className="flex max-w-[350px] flex-col gap-4">
        ...
        <div className="flex items-center gap-3">
          ...
          <div className="flex flex-col gap-1">
            ...
            <div className="bg-action-secondary-background-pressed h-3 w-24 animate-pulse rounded" />
          </div>
        </div>
        ...
        <div className="mt-auto flex items-center gap-2">
          ...
          <div className="bg-action-secondary-background-pressed h-6 w-16 animate-pulse rounded-full" />
