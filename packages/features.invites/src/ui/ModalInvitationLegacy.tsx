...
type ModalInvitationLegacyProps = {
...
/**
 * Старая модалка со списком/созданием/удалением приглашений (таблица).
 * Не удаляем на случай необходимости временного отката — см.
 * `VITE_LEGACY_INVITES_MODAL_ENABLED` в `common.env` и `ModalInvitation.tsx`.
 * Логика не менялась.
 */
export const ModalInvitationLegacy = ({
  children,
  open: controlledOpen,
  onOpenChange,
  analyticsSource = 'unknown',
}: ModalInvitationLegacyProps) => {
