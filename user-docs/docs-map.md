...
| `docs-draft/06-payments/payments-analytics.mdx`                            | Аналитика: что показывают плитки                                          | Период, KPI, график, очередь счетов   | Да                    |
...
**Итого:** 51 MDX-файл, без сгенерированного `meta.json` — см. [структуру плана](docs/структура-пользовательской-документации.md).
